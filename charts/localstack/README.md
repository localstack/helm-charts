...
| `startServices`                                      | Comma-separated list of AWS CLI service names which should be loaded right when starting LocalStack. Per default, all services are loaded and started on the first request for that service.                                          | `nil` (Localstack Default)                              |
